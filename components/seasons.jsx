...
const Seasons = () => {
    ...
    return (<div className="seasons-panels-container full-height full-width">
        <SeasonPanel key={"0" + openPanelIndex?.toString()} background="red" index={0} selectedIndex={openPanelIndex} onClick={onPanelClick} img={"bellingrat.jpeg"} clippedImg={"testowo2.jpg"}>
        ...
        <SeasonPanel key={"1" + openPanelIndex?.toString()} background="blue" index={1} selectedIndex={openPanelIndex} onClick={onPanelClick} img={"Keukenhof.jpg"} clippedImg={"Keukenhof.jpg"}>
        ...
        <SeasonPanel key={"2" + openPanelIndex?.toString()} background="pink" index={2} selectedIndex={openPanelIndex} onClick={onPanelClick} img={"testowo2.jpg"} clippedImg={"testowo2.jpg"}>
            <div className="top left font-large bold white seasons-panel-text-header">Jesień</div>
            <div className="bottom right font-medium white seasons-panel-text-desc">It is a long established fact that a reader will be </div>
        </SeasonPanel>
        <SeasonPanel key={"3" + openPanelIndex?.toString()} background="orange" index={3} selectedIndex={openPanelIndex} onClick={onPanelClick} img={"wintergarden.jpg"} clippedImg={"wintergarden.jpg"}>
...
const SeasonPanel = (props) => {
    ...
    return (<div style={style} className={"seasons-panel " + stateClass} onClick={onPanelClick}>
